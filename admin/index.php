...
<form action="check_login.php" method="post">
	<h2>管理员登录</h2><br>
	<div style="margin-left:200px;color:#fff;">管理员名：<input type="text" name="name" id="name"></div>
    <div style="margin-left:200px;color:#fff;">密<span style="color:rgba(0,0,0,0);">一一</span>码：<input type="password" name="pwd" id="pwd"></div>
    <div class="forgot">
