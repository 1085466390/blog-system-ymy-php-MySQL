...
.logCom .com-record .log-right .com-bottom .com-bottom-adcommand .com-bottom-adcommand-con{width:1050px;padding-left:10px;}
...
<div class="logCom">
	<div class="command">
    <?php $trans_id=$_GET['id']; if(!session_id()){session_start();} include("conn.php");?>
    <form action="check_logCom.php?id=<?php echo $trans_id;?>&state=2" method="post">
    	<div class="text"><textarea name="com_content" id="com_content" rows="3" cols="80" onpropertychange="if(this.scrollHeight>80) this.style.posHeight=this.scrollHeight+5" style="background:transparent;border:2px solid #ff9406;"></textarea></div>
    ...
    <?php
	$sql=mysqli_query($conn,"select * from tb_tk_comment join tb_tk_user on tb_tk_user.user_uid = tb_tk_comment.comt_uid where comt_logid='$trans_id' and comt_logord=2 order by comt_time desc");
    ...
    <div class="com-record">
        ...
        <div class="log-right">
            ...
            <div class="com-bottom">
				...
				?>
                <form action="check_logAdCom.php?comt=<?php echo $comt;?>&uid=<?php echo $info['comt_uid'];?>&id=<?php echo $trans_id;?>&state=2" method="post">
                	<div class="adcom-text"><textarea name="adcom_content" id="adcom_content" rows="3" cols="80" onpropertychange="if(this.scrollHeight>80) this.style.posHeight=this.scrollHeight+5" style="background:transparent;border:2px solid #ff9406;"></textarea></div>
